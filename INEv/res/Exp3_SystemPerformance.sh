...
python3 plot_latency_bars.py -i combined_for_latency.csv -x MaximumParents -l Latency -y centralHopLatency MaxPushPullLatency -o Fig_Latency_Density.pdf
python3 multi_variate_latency.py -i combined_for_latency.csv -l Latency -x MaximumParents -y centralHopLatency MaxPushPullLatency -o Fig_Latency_Density_Whikser.pdf
