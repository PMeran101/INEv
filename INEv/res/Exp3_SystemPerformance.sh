...
python3 plot_latency_bars.py -i combined_for_latency_scaled.csv -x Nodes -l ComputationTime -y CombigenComputationTime PushPullTime -o Fig_ComputationTime_Scaled.pdf
