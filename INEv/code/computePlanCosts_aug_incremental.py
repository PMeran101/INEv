...
def main():
   ...
   # print("Hop Latency: " + str(hoplatency))
    ...
    myResult  = [myID,  mycosts, costs , ccosts[0], run, skew]
    schema = ["ID", "SharedRatio", "TotalCosts", "CentralizedCosts", "Run", "Skew"]
    if qwlLength  == iteration :
        
        new = False
        try:
            f = open("multi-query/sharedCosts_15.csv")   
        except FileNotFoundError:
            new = True           
        
        with open("multi-query/sharedCosts_15.csv", "a") as result:
