...
Computes best INEv for new rates, and initial combination, writes new EvaluationPlan.
"""
...
def main():
   ...
   # print("Hop Latency: " + str(hoplatency))
    ...
    schema = ["ID", "Swaps", "Outdated", "INEvCosts", "CentralizeCosts"]
    myResult = [experiment, swaps, outdated, costs, ccosts[0]]
    new = False
